...
//	uint32_t t = tr->choosenum;
	...
	*(volatile unsigned int *)(CONFIG_RESERVED_DTRA_BUFFER + 0x0) = 0xff;
	*(volatile unsigned int *)(CONFIG_RESERVED_DTRA_BUFFER + 0x4) = 0xff00;
	*(volatile unsigned int *)(CONFIG_RESERVED_DTRA_BUFFER + 0x8) = tr->choosenum;
	*(volatile unsigned int *)(CONFIG_RESERVED_DTRA_BUFFER + 0xc) = tr->t_mode;
	...
	for(i = 0; i < total; i++){
	    info = (struct train_info *)(CONFIG_RESERVED_DTRA_BUFFER + 0x10 + i * TRAIN_INFO_LEN);
