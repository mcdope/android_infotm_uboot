...
#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_sam_4x128_8_270M_coby.h"
...
#define CONFIG_LINUX_RECOVER_BOOTARGS "console=ttySAC3,115200 androidboot.mode=recovery mem=512M"
#define CONFIG_CMDLINE_PARTITIONS " mtdparts=imapx200:"  \
	"2m@24m(ramdisk),6m@26m(kernel),128m@40m(resv),"  \
	"192m@296m(system),512m@488m(userdata),64m@1000m(cache),"  \
	"3030m@1064m(Local-disk),1m@4094m(panic)"
