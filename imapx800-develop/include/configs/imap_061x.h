...
//#define SOURCE_CHANNEL 1     //iNand/MMCx. if not defined, it will defaultly 0.
...
#define CONFIG_LCD_PANEL_GPIO_Bit	14
...
#define CONFIG_POWER_GPIO_NUM   0x4
...
#define CONFIG_BOARD_HWVER	0x00060100
