...
#define IMAPFB_HFP		20		/* front porch */
#define IMAPFB_HSW		76		/* hsync width */
#define IMAPFB_HBP		80		/* back porch */
#define IMAPFB_VFP		3		/* front porch */
...
#define CONFIG_BOARD_HWVER	0x00050001
