...
#define CONFIG_MENU_KEY_GPIO_NUM 2
#endif
...
/* (back) */
#define CONFIG_RECOVERY_KEY2_GPIO GPEDAT
#define CONFIG_RECOVERY_KEY2_GPIO_NUM 0
#define CONFIG_RECOVERY_KEY2_GPIO_NAME "KEY_BACK"
#endif
...
/* Memory configuration */
	...
	#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_scs_2x256_270Mau_m77.h"
#else
	#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_sam_2x128_270Mau_m77.h"
#endif
...
/* Boot Env */
#define CONFIG_LINUX_DEFAULT_BOOTARGS "console=ttySAC3,115200 bootdelay=15"
...
#define CONFIG_ETH_RESET_GPIO	GPPDAT
#define CONFIG_ETH_RESET_GPIO_NUM	8
#endif
...
//#define CONFIG_LCD_EXTRA_GPIO		GPODAT
//#define CONFIG_LCD_EXTRA_GPIO_Bit	13
#define CONFIG_LCD_BL_GPIO			GPADAT
#define CONFIG_LCD_BL_GPIO_Bit		6
#define CONFIG_LCD_RESET_GPIO		GPFDAT
#define CONFIG_LCD_RESET_GPIO_Bit	7
#define CONFIG_LCD_TOUT_PIN			2
#define CONFIG_LCDCON5				0x24000308
#define CONFIG_DIV_CFG4_VAL			0x1e1e
#define CONFIG_LCDCON1_CLKVAL		1	
...
#define CONFIG_SYS_INIT_GPIO2_VAL (1 << 26)
#define CONFIG_SYS_INIT_GPIO3 GPODAT
#define CONFIG_SYS_INIT_GPIO3_VAL (1 << 13)
#endif

/* More Init GPIOs */
/* GPIO, BIT, DIR(0:out, 1:in), VAL */
