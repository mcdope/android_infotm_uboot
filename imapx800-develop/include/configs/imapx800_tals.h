...
#define CONFIG_SYS_SDRAM_END	0x90000000		/* 256 MB total */
...
/* Boot Env */
#define CONFIG_LINUX_DEFAULT_BOOTARGS "console=ttyAMA3,115200"
#define CONFIG_LINUX_RECOVER_BOOTARGS "console=ttyAMA3,115200"
