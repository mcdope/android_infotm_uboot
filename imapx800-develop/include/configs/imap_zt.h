...
#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_ZT_0.8G264M.h"
...
#define IMAPFB_VSW		5		/* vsync width */
#define IMAPFB_VBP		34		/* back porch */
...
#define CONFIG_LCD_BL_GPIO			0x20e100b0
#define CONFIG_LCD_BL_GPIO_Bit		3
#define CONFIG_LCD_TOUT_PIN			2
#define CONFIG_LCDCON5				0x06000308
//#define CONFIG_LCD_ENBLCTRL

/* USB */
#define CONFIG_OTG_MENUKEY
#define CONFIG_OTG_GPIO		0x20e10010
#define CONFIG_OTG_GPIO_NUM	4
#define CONFIG_OTG_EX_GPIO		0x20e10000
...
#define CONFIG_BOARD_MAGIC	0xbeadff00
