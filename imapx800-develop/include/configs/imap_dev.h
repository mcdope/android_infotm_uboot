 ...
 * (easy to change)
 */
#define CONFIG_RECOVERY_KEY2_GPIO GPJDAT
#define CONFIG_RECOVERY_KEY2_GPIO_NUM 4
...
#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_micron_800_266.h"
#define PHYS_SDRAM_1_SIZE		0x40000000		/* 1 GB in Bank #1 */
#define CONFIG_SYS_SDRAM_END	0x60000000		/* 1 GB total */

/* Board string */

/* Boot Env */
#define CONFIG_LINUX_DEFAULT_BOOTARGS "console=ttySAC0,115200 androidboot.mode=normal mem=256M"
#define CONFIG_LINUX_RECOVER_BOOTARGS "console=ttySAC0,115200 androidboot.mode=recovery mem=256M"
...
#define CONFIG_LCD_PANEL_GPIO		0x20e10050	
#define CONFIG_LCD_PANEL_GPIO_Bit	7
#define CONFIG_LCD_BL_GPIO			0x20e10050
...
#define CONFIG_BOARD_MAGIC	0xeef00000
#define CONFIG_BOARD_HWVER	0x00000001
#define CONFIG_BOARD_OEM	0x1
