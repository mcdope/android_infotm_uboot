...
/* Home */
#define CONFIG_RECOVERY_KEY1_GPIO		GPEDAT
#define CONFIG_RECOVERY_KEY1_GPIO_NUM	14
...
#define CONFIG_SAM_2_128_264M_NOAU
//#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_sam_2x128_270M.h"
#define CONFIG_SYS_DENALI_FILE  "asm/arch/denali_data/denali_init_7901uc.h"
...
#define CONFIG_LCD_PANEL_GPIO_Bit	4
#define CONFIG_LCD_BL_GPIO			GPODAT	
#define CONFIG_LCD_BL_GPIO_Bit		4
#define CONFIG_LCD_TOUT_PIN			0
#define CONFIG_LCDCON5				0x24000308
#define CONFIG_LCD_BL_DELAY                     500000
//#define CONFIG_LCD_ENBLCTRL

/* SPI */
#define CONFIG_IMAPX200_SPI
#define CONFIG_LOW_BATTERY_VAL        530// zheng chang kai ji dian liang
#define CONFIG_LOGO_BATTERY_VAL       480//  xiao qi e chu xian
/* USB */
...
#define CONFIG_BOARD_HWVER	0x00020301
#define CONFIG_BOARD_OEM	0
