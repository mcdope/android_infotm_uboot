...
//#define CONFIG_HIBERNATE      //Hiberat location capacity value. If define this macro, Hiberat location will be enabled autom
#endif
...
/* DDR2 auto-adjust option */
//#define CONFIG_BOOT_AUTO_ADJUST
//#define CONFIG_DENALI_CL_5
...
#define CONFIG_SYS_DENALI_FILE	"asm/arch/denali_data/denali_sam_4_128_270M_CL_5.h"
#define PHYS_SDRAM_1_SIZE		0x10000000		/* 256 MB in Bank #1 */
#define CONFIG_SYS_SDRAM_END	0x60000000		/* 256 MB total */
...
/* Boot Env */
#define CONFIG_LINUX_DEFAULT_BOOTARGS "console=ttySAC3,115200 androidboot.mode=normal mem=512M"
...
#define CONFIG_SYS_INIT_GPIO0_VAL 0x4000000
#define CONFIG_SYS_INIT_GPIO1 GPODAT
#define CONFIG_SYS_INIT_GPIO1_VAL 0x2000

#define CONFIG_SYS_INIT_GPIO2 GPACON
#define CONFIG_SYS_INIT_GPIO2_VAL 0x10
#define CONFIG_SYS_INIT_GPIO3 GPADAT
#define CONFIG_SYS_INIT_GPIO3_VAL 0x4
#endif
...
#define CONFIG_BOARD_HWVER	0x00060205
