...
#define CONFIG_GZIP_LOGO_FILE	<logo_zhCN.bin.gz.h>
...
//#define CONFIG_LCD_PANEL_GPIO		0x20E10020	
//#define CONFIG_LCD_PANEL_GPIO_Bit	5
...
#define CONFIG_BOARD_MAGIC	0xffffffff
#define CONFIG_BOARD_HWVER	0x00070103
