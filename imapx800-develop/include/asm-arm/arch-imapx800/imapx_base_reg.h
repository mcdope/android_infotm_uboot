...
#define HDMI_TX_BASE_ADDR					(PERI_BASE_PA+0xE00000)
#define GPIO_BASE_ADDR						(PERI_BASE_PA+0xF00000)
#define MIPI_DSI_BASE_ADDR					(PERI_BASE_PA+0x1000000)
#define LVDS_TX_BASE_ADDR					(PERI_BASE_PA+0x1100000)
#define PWDT_BASE_ADDR						(PERI_BASE_PA+0x1200000)
#define GDMA_BASE_ADDR						(PERI_BASE_PA+0x1800000)
...
#define GPS_BASE_ADDR						(PERI_BASE_PA+0x3200000)
#define GPU_BASE_ADDR						(PERI_BASE_PA+0x4000000)
#define VDEC_BASE_ADDR						(PERI_BASE_PA+0x5000000)
#define VENC_BASE_ADDR						(PERI_BASE_PA+0x5100000)
#define VP8_BASE_ADDR						(PERI_BASE_PA+0x5200000)
#define ISP_BASE_ADDR						(PERI_BASE_PA+0x6000000)
#define MIPI_CSI_BASE_ADDR					(PERI_BASE_PA+0x6100000)
...
#define MAC_BASE_ADDR						(PERI_BASE_PA+0x8300000)
#define CRYPTO_BASE_ADDR					(PERI_BASE_PA+0x3200000)
#define NF2_BASE_ADDR						(PERI_BASE_PA+0x8000000)
...
#define GDMA_SYSM_ADDR                      (SYSMGR_BASE_ADDR + 0x8000)
...
#define MAC_SYSM_ADDR						(SYSMGR_BASE_ADDR + 0x3cc00)
