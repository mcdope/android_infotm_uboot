...
//	int			(* w2)(uint8_t *buf, loff_t start, int length, int extra);
	int			(* reset)(void);
	int			(* erase)(loff_t start, uint32_t size);
	int			(* scrub)(loff_t start, uint32_t size);
...
extern int vs_read (uint8_t *buf, loff_t start, int length, int extra);
extern int vs_write(uint8_t *buf, loff_t start, int length, int extra);
extern int vs_erase(loff_t start, uint32_t size);
extern int vs_isbad(loff_t start);
//extern int vs_w2(uint8_t *buf, loff_t start, int length, int extra);
extern int vs_scrub(loff_t start, uint32_t size);
