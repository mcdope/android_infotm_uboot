...
TftpHandler (uchar * pkt, unsigned dest, unsigned src, unsigned len)
{
	...
	case TFTP_DATA:
		...
		/* Display speed infomation */
		{
			static uint32_t tmp;
			if(tmp != NetBootFileXferSize >> 17)
			{
				printf("%2d.%d MB\b\b\b\b\b\b\b", (int)(NetBootFileXferSize >> 20), (int)(((NetBootFileXferSize & 0xfffff) * 10) >> 20));
				tmp = NetBootFileXferSize >> 17;
			}
		}
